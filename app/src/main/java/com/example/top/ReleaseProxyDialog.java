...
public class ReleaseProxyDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        builder.setTitle(owner_ryosei_room + " " + owner_ryosei_name + " の荷物を引き渡します。" + br + "※注意 代理人" + proxy_room + " " + proxy_name + "に引渡します。")
