...
public class ProxyChangeDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        builder.setTitle("代理人選択").setMessage(proxy_ryosei_room + "を代理人として設定します。").setPositiveButton("設定する", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                // このボタンを押した時の処理を書きます。
                Toast.makeText(getActivity(), proxy_ryosei_room + "を代理人として設定しました。", Toast.LENGTH_SHORT).show();
                //呼び出し元のフラグメントに結果を返す
                ReleaseProxyActivity callingActivity = (ReleaseProxyActivity) getActivity();
